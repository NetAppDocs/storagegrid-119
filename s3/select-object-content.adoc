...
For more information see https://docs.aws.amazon.com/AmazonS3/latest/API/API_SelectObjectContent.html[Amazon Simple Storage Service API Reference: SelectObjectContent^].
