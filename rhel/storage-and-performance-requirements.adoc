...
*Note:* A software-based Storage Node can have 1 to 48 storage volumes; at least 3 storage volumes are recommended.
...
NOTE: An appliance Storage Node can also have up to 48 storage volumes.
