...
To configure CSRF protection, use the link:../admin/using-grid-management-api.html[Grid Management API] or link:../tenant/understanding-tenant-management-api.html[Tenant Management API].
